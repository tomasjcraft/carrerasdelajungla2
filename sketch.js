...
function reset(){
  ...
  kangaroo.changeAnimation("running", kangaroo_running); // Cambia la animación del canguro al reiniciar
  shrubsGroup.destroyEach(); // Destruye el grupo de arbustos
  obstaclesGroup.destroyEach(); // Destruye el grupo de obstáculos
  score = 0;
}
